...
const ContactUs = () => {
  return (
    <div class="p-2 dark:bg-gray-800 ">
      ...
      <div class="grid sm:grid-cols-2 items-start gap-12 p-8 mx-auto mb-5 max-w-4xl bg-white shadow-[0_2px_5px_5px_rgba(255,165,0,0.3)] rounded-md font-[sans-serif] dark:bg-gray-800">
        ...
        <div>
          ...
          <li class="flex items-center">
            <a href="mailto:info@example.com" class="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
      ...
      <a href="mailto:info@example.com" class="text-[#007bff] text-sm ml-4">
...
<div class="mt-12">
  ...
  <ul class="flex mt-4 space-x-4">
    <li>
      <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" class="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
        <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill='#007bff'
          viewBox="0 0 24 24">
          <path
    ...
    <li>
      <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" class="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
        <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill='#007bff'
          viewBox="0 0 511 512">
          <path
    ...
    <li>
      <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" class="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
        <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill='#007bff'
          viewBox="0 0 24 24">
          <path
