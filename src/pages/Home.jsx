    ...
    <div className="min-h-screen bg-white dark:bg-slate-900">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative px-4 py-32 text-center">
          <div className="inline-flex items-center px-8 py-4 mb-12 bg-gray-50 dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-2xl shadow-sm">
            ...
            <span className="text-base font-semibold text-gray-800 dark:text-gray-200">Fresh Content</span>
            <div className="w-1.5 h-1.5 bg-gray-400 rounded-full mx-4"></div>
            <span className="text-base text-gray-600 dark:text-gray-300">Updated Daily</span>
          </div>
          ...
          <div className="mt-16 flex justify-center items-center space-x-8">
            <div className="w-20 h-0.5 bg-gradient-to-r from-transparent via-orange-400 to-transparent"></div>
          ...
          {loading ? (
            <div className="flex items-center justify-center min-h-96">
              <div className="text-center space-y-8">
                <div className="relative">
                  <div className="w-20 h-20 border-4 border-orange-200 dark:border-orange-800 rounded-full animate-spin"></div>
                ...
                <div className="space-y-2">
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white">Loading Content</h3>
                  <p className="text-lg text-gray-600 dark:text-gray-300">Preparing amazing insights for you...</p>
                </div>
              </div>
            </div>
          ) : (
            <div className="space-y-16">
              <div className="text-center space-y-6">
                <h2 className="text-5xl font-bold bg-gradient-to-r from-gray-900 via-orange-700 to-red-700 dark:from-white dark:via-orange-300 dark:to-red-300 bg-clip-text text-transparent">
                  Featured Stories
                </h2>
                <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                  Curated content from industry leaders and innovators
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 3xl:grid-cols-5 4xl:grid-cols-6 gap-8">
                {posts.map((post, index) => (
                  ...
                  >
                    <div className="absolute -inset-2 bg-gradient-to-r from-orange-400/20 via-red-400/20 to-orange-400/20 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-xl"></div>
                    
                    <div className="relative bg-white dark:bg-slate-900 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden border border-gray-200/50 dark:border-slate-700/50 hover:border-orange-200 dark:hover:border-orange-800/50">
                      <PostCard {...post} />
                    </div>

                    <div className="absolute -top-2 -right-2 w-6 h-6 bg-gradient-to-r from-orange-400 to-red-400 rounded-full opacity-0 group-hover:opacity-100 transition-all duration-300 shadow-lg"></div>
                  </div>
                ))}
              </div>
            </div>
