            ...
            <div className="space-y-6">
              ...
              <div className="flex justify-center md:justify-start space-x-4">
                ...
                <a href="https://linkedin.com" className="group">
                  <div className="bg-white p-2 rounded-lg shadow-md border border-gray-300 group-hover:border-[#0077B5] group-hover:shadow-lg transition-all duration-300 transform group-hover:-translate-y-1 group-hover:scale-105 dark:border-gray-700 dark:bg-gray-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 text-center md:text-left">
          ...
          <div className="mt-5 text-center">
            <p className="text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 transition-colors duration-300">
              ...
              <Link to="/" className="relative ml-1 font-semibold group cursor-pointer">
                TechieBlog
