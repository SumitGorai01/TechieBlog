                    ...
                    <form onSubmit={handleSubmit(submit)} className="p-8 pt-4 space-y-8">
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            <div className="space-y-4">
                                ...
                                <div className="relative backdrop-blur-sm bg-white/50 dark:bg-gray-800/30 rounded-2xl border-2 border-dashed border-orange-300/50 dark:border-orange-400/30 p-6 cursor-pointer">
                                    <Input
                                        type="file"
