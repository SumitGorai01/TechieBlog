...
export default function PostForm({ post }) {
  ...
  // Common function to set preview & name
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-orange-50 via-amber-50 to-orange-100 dark:from-gray-900 dark:via-orange-950/20 dark:to-gray-800">
        ...
        <div
          className="absolute top-1/2 left-1/3 w-64 h-64 bg-orange-300/20 dark:bg-orange-500/10 rounded-full blur-2xl animate-bounce delay-2000"
        ...
        <div className="backdrop-blur-xl bg-white/70 dark:bg-gray-900/40 border border-white/20 dark:border-gray-700/30 rounded-3xl shadow-2xl shadow-orange-500/10 dark:shadow-orange-400/5 overflow-hidden">
          <div className="relative p-8 pb-6">
            ...
            <p className="text-center text-gray-600 dark:text-gray-400 font-medium">
              {post
                ? "Update your content with style"
          ...
          <form onSubmit={handleSubmit(submit)} className="p-8 pt-4 space-y-8">
           ...
           {/* Drag & Drop + Preview side-by-side */}
           <label className="block text-lg font-semibold text-gray-700 dark:text-gray-300 flex items-center gap-2">
      <span className="w-2 h-2 bg-orange-400 rounded-full animate-pulse"></span>
      Featured Image
    </label>
<div className="grid md:grid-cols-2 gap-8">
  ...
  <div
    className={`group relative backdrop-blur-sm rounded-2xl border-2 border-dashed transition-all duration-300 p-6 cursor-pointer 
      ${dragOver
        ? "border-orange-500 bg-orange-100/40 dark:bg-orange-500/20"
        : "border-orange-300/50 dark:border-orange-400/30 bg-white/50 dark:bg-gray-800/30"
      }`}
    onDragOver={(e) => {
      e.preventDefault();
      setDragOver(true);
  ...
  <Button
    type="submit"
    disabled={loading}
    className={`group relative w-full py-5 px-8 rounded-2xl font-bold text-lg text-white 
